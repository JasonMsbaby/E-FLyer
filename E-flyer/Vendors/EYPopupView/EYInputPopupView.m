            ...
            dismissBlock:(dispatch_block_t)dismissBlock
{
    ...
    [popView.rightBtn setBackgroundImage:[UIImage imageWithColor:COLORRGB(0x1C86EE)] forState:UIControlStateNormal];
    [popView.leftBtn setBackgroundImage:[UIImage imageWithColor:COLORRGB(0xCD3700)] forState:UIControlStateNormal];
