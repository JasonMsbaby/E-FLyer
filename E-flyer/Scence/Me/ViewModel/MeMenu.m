...
+ (NSDictionary *)menuListWithUser:(EFUser *)currentUser{
    //商家个人菜单
    MeMenu *m1_1 = [[MeMenu alloc]initWithTitle:@"个人信息" Image:@"me_setting" IDD:@"personInfo" HaveNext:YES];
    MeMenu *m1_2 = [[MeMenu alloc]initWithTitle:@"店铺信息" Image:@"me_setting" IDD:@"barInfo" HaveNext:YES];
    MeMenu *m1_3= [[MeMenu alloc]initWithTitle:@"用户数据" Image:@"me_setting" IDD:@"userInfo" HaveNext:YES];
    MeMenu *m1_4 = [[MeMenu alloc]initWithTitle:@"商品管理" Image:@"me_setting" IDD:@"goodsInfo" HaveNext:YES];
    MeMenu *m1_5 = [[MeMenu alloc]initWithTitle:@"账户管理" Image:@"me_setting" IDD:@"acountInfo" HaveNext:YES];
    ...
    //通用菜单
    MeMenu *m2_1 = [[MeMenu alloc]initWithTitle:@"关于我们" Image:@"me_setting" IDD:@"personInfo" HaveNext:YES];
    MeMenu *m2_2 = [[MeMenu alloc]initWithTitle:@"退出登录" Image:@"me_setting" IDD:@"exit" HaveNext:NO];
