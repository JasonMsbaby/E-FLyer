...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        self.navigationItem.title = @"房税常识";
         NSDictionary *dic = @{@"Cell": @"MainCell",@"isAttached":@(NO),@"title":@"1.契税"};
        NSDictionary *dicTwo = @{@"Cell": @"MainCell",@"isAttached":@(NO),@"title":@"2.个税"};
        NSDictionary *dicThree = @{@"Cell": @"MainCell",@"isAttached":@(NO),@"title":@"3.营业税"};
        NSDictionary *dicFour = @{@"Cell": @"MainCell",@"isAttached":@(NO),@"title":@"4.土地出让金"};
        NSDictionary *dicFive = @{@"Cell": @"MainCell",@"isAttached":@(NO),@"title":@"5.中介服务费"};
        NSDictionary *dicSix = @{@"Cell": @"MainCell",@"isAttached":@(NO),@"title":@"6.上市"};
        NSDictionary *dicSeven = @{@"Cell": @"MainCell",@"isAttached":@(NO),@"title":@"7.贷款代办费"};
        
         NSArray * array = @[dic,dicTwo,dicThree,dicFour,dicFive,dicSix,dicSeven];
        if (self.dataArray == nil) {
            self.dataArray = [[[NSMutableArray alloc]init]autorelease];
        }
         self.dataArray = [NSMutableArray arrayWithArray:array];
        self.titleArray = [[[NSArray alloc]initWithObjects:@"1.契税",@"2.个税",@"3.营业税",@"4.土地出让金",@"5.中介服务费",@"6.上市",@"7.贷款代办费", nil]autorelease];
    }
    return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[self.dataArray[indexPath.row] objectForKey:@"Cell"] isEqualToString:@"MainCell"])
    {
        ...
        cell.imgView.image= [UIImage imageNamed:@"area_filter_unfold@2x"];
        ...
        NSString *path = [[NSBundle mainBundle]pathForResource:title ofType:@"txt"];
